...
using BruteForceMethod.VisualizationPages;
using System;
using System.Data;
...
namespace BruteForceMethod
{
    public static class BruteForceMethod
    {
        ...
        public static Tuple<Point,Point> GetInfo(CorrectionFactors correctionFactors, Limitations limitations, ExhaustiveSearchFactors exhaustiveSearchFactors)
        {
            try
            {
            ...
            catch (Exception) { return new Tuple<Point, Point>(null, null); }
        }
